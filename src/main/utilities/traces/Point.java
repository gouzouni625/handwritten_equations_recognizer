...
public class Point{
   ...
   *
   *  The addition is the typical mathematical addition. That is, if P1(x1, y1) and P2(x2, y2) are two points in
   ...
   *
   *  The multiplication is the typical mathematical multiplication. That is, if P1(x1, y1) is a point in mathematical
   ...
   *
   *  The division is the typical mathematical division. That is, if P1(x1, y1) is a point in mathematical notation and
   *  d is a double, then, the result of dividing P1 by d is a point P2(x1 /d, y1 / d). In case where d == 0 an
   *  ArithmeticException is thrown with the message "/ by zero.".
   ...
   *
   *  The subtraction is the typical mathematical point - point subtraction. That is, if P1(x1, y1) and P2(x2, y2) are
   ...
   *
   *  The distance is the Euclidean distance of the two Points. That is, if P1(x1, y1) and P2(x2, y2) are two points in
   *  mathematical notation, then, their Euclidean distance d, is calculated as
