...
import main.java.classifiers.Classifier;
import main.java.utilities.traces.TraceGroup;

/** @class Partitioner
 *
 *  @brief A Partitioner splits a set of traces to groups. Each group of these traces represents a symbol.
 */
public abstract class Partitioner{
  ...
  protected Classifier classifier_; //!< The Classifier used by this Partitioner to partition the given equation.
