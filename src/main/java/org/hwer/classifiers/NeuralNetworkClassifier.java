...
public class NeuralNetworkClassifier extends Classifier{
  ...
  public double classify(TraceGroup symbol, TraceGroup context, boolean subSymbolCheck,
    ...
    BufferedImage image = printTraceGroup(symbol, imageDistorter_.getSampleColumns(),
  ...
  private BufferedImage printTraceGroup(TraceGroup traceGroup, int width, int height,
                                        int thickness){
