...
import org.hwer.image_processing.Core;
...
public class NeuralNetworkClassifier extends Classifier{
  ...
  public double classify(TraceGroup symbol, TraceGroup context, boolean subSymbolCheck,
    ...
    BufferedImage image = imageProcessor_.printTraceGroup(symbol,
        imageDistorter_.getSampleColumns(), imageDistorter_.getSampleRows(), 30);
