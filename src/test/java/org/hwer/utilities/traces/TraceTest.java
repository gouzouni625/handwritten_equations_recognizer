...
import org.hwer.utilities.traces.Point;
import org.hwer.utilities.traces.Trace;

/** @class TraceTest
 *
 *  @brief Class that contains tests for main.java.utilities.traces.Trace class.
 */
public class TraceTest{
  /**
   *  @brief Tests the constructors of main.java.utilities.traces.Trace class.
   */
  @Test
  ...
  /**
   *  @brief Tests add and size methods of main.java.utilities.traces.Trace class.
   */
  @Test
  ...
  /**
   *  @brief Tests get method of main.java.utilities.traces.Trace class.
   */
  @Test
  public void testGet(){
    double x = Math.random() * 100;
  ...
  /**
   *  @brief Tests multiplyBy method of main.java.utilities.traces.Trace class.
   */
  @Test
  ...
  /**
   *  @brief Tests subtract method of main.java.utilities.traces.Trace class.
   */
  @Test
   ...
   *  getWidth and getHeight methods of main.java.utilities.traces.Trace class.
   */
  @Test
  ...
  /**
   *  @brief Tests getCentroid method of main.java.utilities.traces.Trace class.
   */
  @Test
  ...
  /**
   *  @brief Tests getCenterOfMass method of main.java.utilities.traces.Trace class.
   */
  @Test
  ...
  /**
   *  @brief Tests minimumDistance method of main.java.utilities.traces.Trace class.
   */
  @Test
  ...
  /**
   *  @brief Tests closestPoints method of main.java.utilities.traces.Trace class.
   */
  @Test
  ...
  /**
   *  @brief Tests closestPoint method of main.java.utilities.traces.Trace class.
   */
  @Test
  ...
  /**
   *  @brief Tests toInkMLFormat method of main.java.utilities.traces.Trace class.
   */
  @Test
